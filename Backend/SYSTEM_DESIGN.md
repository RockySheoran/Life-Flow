...
This section outlines the basic data structures for the core services.
...
*   **BloodRequest:**
    ...
    *   `hospitalId` (Foreign Key to User)
    *   `bloodType`
    *   `quantity`
    *   `status` (e.g., PENDING, FULFILLED, CANCELED)
